...
export const DataWorkspace: FC<DataWorkspaceProps> = (props) => {
  ...
  return (
    <div className={className}>
      <PageSpaceTree />
      <WorkSpaceTree
        title={`${t("editor.data_work_space.components_title")}(${widgetExecutionArray.length
          })`}
      ...
      />
      <WorkSpaceTree
        title={`${t("editor.data_work_space.actions_title")}(${actionExecutionArray.length
          })`}
      ...
      />
      <WorkSpaceTree
        title={`${t("editor.data_work_space.globals_title")}(${globalInfoList.length
          })`}
