  ...
  switch (pattern) {
    case "Email": {
      if (
        ...
        return t(invalidMessage.get("email")!)
      }
      break
    }
    case "URL": {
      if (
        ...
        return t(invalidMessage.get("url")!)
      }
      break
    }
    case "Regex":
      ...
      try {
        ...
        if (!matchPattern.test(stringValue)) {
          return t(invalidMessage.get("regex")!)
        }
      } catch (e) {
