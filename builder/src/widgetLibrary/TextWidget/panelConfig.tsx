    ...
    children: [
      {
        ...
        labelName: t("editor.inspect.setter_label.content"),
        labelDesc: t("editor.inspect.setter_tooltip.text_value"),
        attrName: "disableMarkdown",
        setterType: "RADIO_GROUP_SETTER",
        options: [
          { label: "Markdown", value: false },
          { label: t("widget.text.text_model"), value: true },
        ],
      },
      {
    ...
    children: [
      {
        ...
        labelName: t("editor.inspect.setter_label.horizontal_alignment"),
      ...
      },
      {
        ...
        labelName: t("editor.inspect.setter_label.vertical_alignment"),
        setterType: "RADIO_GROUP_SETTER",
